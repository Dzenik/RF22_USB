...
/*
	spi functions
*/
void rfm23_spi_init(void);
uint8_t rfm23_spi_write(uint8_t val);
void rfm23_spi_select(void);
void rfm23_spi_unselect(void);
...
uint8_t rfm23_test(void);
void rfm23_reset(void);
...
/*
	interrupt functions
*/
uint8_t rfm23_on_nirq(void);
uint8_t rfm23_on_interrupt(void);
void rfm23_handle_interrupt(void);
void rfm23_enable_interrupt_1(uint8_t ir);
void rfm23_enable_interrupt_2(uint8_t ir);
uint8_t rfm23_get_isr_1(void);
uint8_t rfm23_get_isr_2(void);


/*
	operating mode functions
*/
void rfm23_mode_ready(void);
void rfm23_mode_tx(void);
void rfm23_mode_rx(void);
void rfm23_mode_wakeup(void);


/*
	fifo functions
*/
void rfm23_clear_rxfifo(void);
void rfm23_clear_txfifo(void);
...
uint8_t rfm23_get_packet_length(void);
...
/*
	other functions
*/
uint8_t rfm23_get_temperature(void);
